...
{
	/* Pins of display configured as GPIO pin during SystemInit */
	/* Seteo los pines del display como salidas */
	...
	Chip_GPIO_WriteDirBit(LPC_GPIO, 2, 12, true);

	Chip_GPIO_WriteDirBit(LPC_GPIO, 2, 8, true);

	/* Seteo los pines de los botones como entradas */
